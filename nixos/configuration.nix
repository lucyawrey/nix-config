...
# Use this to configure your system environment (it replaces /etc/nixos/configuration.nix)
{
  ...
  users.users = {
    lucy = {
      ...
      initialPassword = "divinemelondancingmoon";
      isNormalUser = true;
      description = "Lucy Awrey";
  ...
  environment.shellAliases = {
    ...
    revuild-remote = "sudo nixos-rebuild switch --flake https://github.com/lucyawrey/nix-config#nixos";
    dc = "docker compose";
    pnpi = "pnpm install";
    pnpr = "pnpm run";
    pnpx = "pnpm exec";
